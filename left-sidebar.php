...
<head>
	...
	<title>Website Template: Simple Organization - Left Sidebar (demo)</title>
</head>
...
<div id="site-wrapper">
	...
	<div id="header">
		...
		<div class="navigation" id="sub-nav">
			...
			<ul class="tabbed">
				...
				<li class="current-tab"><a href="left-sidebar.html">Left Sidebar</a></li>
	...
	<div id="splash">
		...
		<div class="col3-mid left">
			...
			<p><img src="img/sample-event.jpg" width="240" height="80" alt="" class="bordered" /></p>
				...
				<div class="section-content">
					...
					<div class="post">
						...
						<div class="post-body">
							...
							<p class="large">This is a free website template by <a href="https://arcsin.se/">Arcsin</a>, built using tableless XHTML and CSS.</p>
